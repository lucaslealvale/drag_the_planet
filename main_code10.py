...
def dez():
    ...
    caixa_fixa1 = obs(950, 220)#1


    caixa_fixa2= pygame.image.load("caixa2.png").convert_alpha()#2
    caixa_fixa3 = obs(400, 520)#2

    caixa_fixa4= pygame.image.load("caixa2.png").convert_alpha()
    caixa_fixa5=obs(700,100)
    ...
    inicio=0
    lvl_10_img=pygame.image.load('lvl_10_img.png')
    ...
    def simula(v,caixa,lugar):
        ...
        while True:
            ...
            z=((caixa_fixa3.x - caixa.x)**2+(caixa_fixa3.y - caixa.y)**2)**0.5

            c=((caixa_fixa5.x - caixa.x)**2+(caixa_fixa5.y - caixa.y)**2)**0.5
